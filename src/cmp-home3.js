                            ...
                            <div class="d-flex flex-shrink-0 p-3" style="width: 222px; border-top-left-radius: 1rem; border-top-right-radius: 1rem; height: 10rem; ">
                                ...
                                <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
                                    ...
                                    <div id="equipoDetails" ?hidden=${!this.equipoencontrado}>
                                        ...
                                        <button @click=${this.closeEquipoDetails} style="width: 8rem; border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Cerrar</button>
                                    </div>
                                    </div>
                                </ul>
                                <hr>
            ...
            <tbody>
              ${this.equipos.map(equip => html`
                <tr>
                  ...
                  <td>
                    <button @click=${() => this.showEquipoDetails(equip)} class="btn btn-primary" style="border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Ver Detalles</button>
                  </td>
                </tr>
              `)}
            </tbody>
