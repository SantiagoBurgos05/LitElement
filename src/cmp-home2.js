                            ...
                            <div class="d-flex flex-shrink-0 p-3" style="width: 222px; border-top-left-radius: 1rem; border-top-right-radius: 1rem; height: 10rem; ">
                                ...
                                <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
                                    ...
                                    <div id="campañaDetails" ?hidden=${!this.campañaencontrada}>
                                        ...
                                        <button @click=${this.closeCampañaDetails} style="width: 8rem; border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Cerrar</button>
                                    </div>
                                    </div>
                        ...
                        <tbody>
                          ${this.campañas.map(camp => html`
                            <tr>
                              ...
                              <td>${camp.director}</td>
                              <td>
                                <button @click=${() => this.toggleCampañaActiva(camp)} class="btn btn-primary" style="border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">
                                  ${camp.isActiva ? 'Desactivar' : 'Activar'}
                                </button>
                                <button @click=${() => this.showCampañaDetails(camp)} class="btn btn-primary" style="border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Ver Detalles</button>
                              </td>
                            </tr>
                          `)}
                        </tbody>
