                                    ...
                                    <div class="d-flex flex-shrink-0 p-3" style="width: 222px; background-color: rgb(201, 205, 207); border-top-left-radius: 1rem; border-top-right-radius: 1rem; height: 10rem; ">
                                        ...
                                        <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button @click=${this.buscarUsuario} class="mt-2 text-center" style="width: 5rem; border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;" ?disabled=${this.isModalOpen}>Buscar</button>
                                            </div>                                            
                                            ...
                                            ${this.usuarioEncontrado
                                                ? html`
                                                    ...
                                                    <button @click=${this.abrirModalLlamada} class="mt-2 text-center" style="width: 5rem; border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Llamar</button>
                                                    <button @click=${this.closeModal} class="mt-2 text-center" style="width: 5rem; border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Cerrar</button>
                                                `
                                                : ''}
                                        </div>
                                                ...
                                                <button @click=${() => this.usuarioSeleccionado = null} style="width: 8rem; border-radius: 5px; border: #D3B6F0; background-color: rgb(250, 101, 101); color: white;">Cerrar</button>
                                ...
                                <div class="d-flex justify-content-around">
                                    <div class="ml-5 d-flex justify-content-around">
                                        ...
                                        &nbsp&nbsp&nbsp
                                            ...
                                            <button @click=${this.openModal} class="mt-1 text-center" style="width: 70px; height: 40px; border-radius: 5px; border: rgb(250, 101, 101); background-color: #D3B6F0; color: white;">Nuevo</button>                                            
                                            </div>
                                    </div>
                                </div>
